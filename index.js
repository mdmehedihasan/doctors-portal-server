...
async function run() {
    try {
        ...
        //not show all the user dashboard
        ...
        app.get('/available', async (req, res) => {
            ...
            services.forEach(service => {
                ...
                //step 5:seletct slots for the service Bookings ['','','']
        ...
        * app.get('/booking') //get all the booking in this collection or get more than one or by filter 
        * app.get('/booking/:id') // get all specific booking
        ...
        */
        ...
        //show doctor info on UI
        app.get('/doctor', verifyJWT, verifyAdmin, async (req, res) => {
            const dooctors = await doctorCollection.find().toArray();
            res.send(dooctors);
        })
